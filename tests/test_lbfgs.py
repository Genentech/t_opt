...
from t_opt.batch_lbfgs import MultiInstanceHistory, BatchLBFGS


from t_opt.coordinates_batch import SameSizeCoordsBatch
from t_opt.opt_util import ConvergenceOpts
from t_opt.pytorch_computer import EnergyAndGradHelper, DummyNet
from t_opt.abstract_NNP_computer import EnergyAndGradHelperHarmConstraint,\
...
# ignore torch.tensor is not callable
# known issue https://github.com/pytorch/pytorch/issues/24807
...
class TestBatchLBFGS():
    ...
    def setup_method(self):
        ...
        with get_mol_input_stream(sdName) as molS:
            for mol in molS:
                xyz = mol.coordinates
