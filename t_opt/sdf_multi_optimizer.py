# encoding: utf-8
'''
This file contains the main method to run the t_opt optimizer over an sdf file.
...
from t_opt.batch_optimizer import BatchOptimizer
import logging
from t_opt.NNP_computer_factory import ExampleNNPComputerFactory, NNPComputerFactoryInterface
from t_opt.opt_util import ConvergenceOpts
...
def main(nnp_comput_factory:NNPComputerFactoryInterface = ExampleNNPComputerFactory,  # type: ignore
         argv=sys.argv): # IGNORE:C0111
    # pylint: disable=W0102, C0415
    """
    ...
    nnp_factory = nnp_comput_factory(args.conf) # type: ignore
...
if __name__ == "__main__":
    ...
    if PROFILE == 1:
        import cProfile
        import pstats
        profile_filename = 't_opt.optimizer_profile.txt'
